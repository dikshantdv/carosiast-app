    ...
    <>
      ...
      >
        <Modal.Content maxWidth="400px">
          {/* <Modal.CloseButton /> */}
          <Modal.Header>EMI Calculator</Modal.Header>
          <Modal.Body>
      ...
      <Pressable
        ...
        style={tailwind`bg-[#EFEFEF] p-1 rounded flex-row items-center flex-1 mr-1 justify-between`}
      >
        <View>
          <Text style={tailwind`font-bold text-base shadow-xl`}>
            EMI Calculator
          </Text>
          <Text>Rs. {priceAbbr(emi)} per month</Text>
        </View>
